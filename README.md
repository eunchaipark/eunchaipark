...
- 안녕하세요, **데이터 엔지니어링**과 **클라우드 기반 솔루션 개발**에 열정을 가지고 있습니다다.
...
- **2024.08.05**: 우리FISA 기술세미나 우승 (1위) – **Loopy**
- **2022.12.17**: 우리FISA 최종프로젝트 최우수 (1위) – **Woodarei**

## 🎓 Education

- **2019.03 ~ 2025.08**: 가톨릭대학교 컴퓨터정보공학/빅데이터 인문 경영학 복수전공
- **2024.04 ~ 2024.06**: 인턴IN메타 응용소프트웨어 1기 수료
- **2024.07 ~ 2024.12**: 우리에프아이에스 아카데미 FISA 수료
...
- **인턴IN메타**: 메타버스를 통한 인턴십, 팀 협업, 코드 리뷰, 문제 해결 및 버그 수정 (2024.04 ~ 2024.06)
- **우리FISA**: 실무 중심 프로젝트 및 협업 경험, AI 엔지니어링 3기 교육과정 수료 (2024.07 ~ 2024.12)
...
- [📝 포트폴리오 링크](https://www.notion.so/1b8460bfbba281ceba45ff4956f3d8f5?pvs=21)
